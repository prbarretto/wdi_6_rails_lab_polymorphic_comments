  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved speaker as @speaker" do
        ...
        post :create, {:speaker => { "make" => "invalid value" }}, valid_session
        expect(assigns(:speaker)).to be_a_new(Speaker)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested speaker" do
        ...
        expect_any_instance_of(Speaker).to receive(:update).with({ "make" => "MyString" })
        put :update, {:id => speaker.to_param, :speaker => { "make" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the speaker as @speaker" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Speaker.any_instance.stub(:save).and_return(false)
        put :update, {:id => speaker.to_param, :speaker => { "make" => "invalid value" }}, valid_session
        expect(assigns(:speaker)).to eq(speaker)
      end
